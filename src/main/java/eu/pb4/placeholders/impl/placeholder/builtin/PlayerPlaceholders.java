...
public class PlayerPlaceholders {
    public static void register() {
        Placeholders.register(Identifier.method_60655("player", "name"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "name_visual"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "name_unformatted"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "ping"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "ping_colored"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "displayname"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "display_name"), Placeholders.getPlaceholders().get(Identifier.method_60655("player", "displayname")));

        Placeholders.register(Identifier.method_60655("player", "displayname_visual"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "display_name_visual"), Placeholders.getPlaceholders().get(Identifier.method_60655("player", "displayname_visual")));

        Placeholders.register(Identifier.method_60655("player", "displayname_unformatted"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "display_name_unformatted"), Placeholders.getPlaceholders().get(Identifier.method_60655("player", "displayname_unformatted")));

        Placeholders.register(Identifier.method_60655("player", "inventory_slot"), (ctx, arg) -> {
        ...
        Placeholders.register(Identifier.method_60655("player", "inventory_slot_no_rarity"), (ctx, arg) -> {
            if (ctx.hasPlayer() && arg != null) {
                try {
                    int slot = Integer.parseInt(arg);
        ...
        Placeholders.register(Identifier.method_60655("player", "equipment_slot"), (ctx, arg) -> {
            if (ctx.hasPlayer() && arg != null) {
                try {
        ...
        Placeholders.register(Identifier.method_60655("player", "equipment_slot_no_rarity"), (ctx, arg) -> {
            if (ctx.hasPlayer() && arg != null) {
                try {
                    var slot = EquipmentSlot.byName(arg);
        ...
        Placeholders.register(Identifier.method_60655("player", "playtime"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "statistic"), (ctx, arg) -> {
            if (ctx.hasPlayer() && arg != null) {
                try {
                    var args = arg.split(" ");
        ...
        Placeholders.register(Identifier.method_60655("player", "statistic_raw"), (ctx, arg) -> {
            if (ctx.hasPlayer() && arg != null) {
                try {
                    var args = arg.split(" ");
        ...
        Placeholders.register(Identifier.method_60655("player", "objective"), (ctx, arg) -> {
            if (ctx.hasPlayer() && arg != null) {
                try {
        ...
        Placeholders.register(Identifier.method_60655("player", "pos_x"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "pos_y"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "pos_z"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "uuid"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "health"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "max_health"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "hunger"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "saturation"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "team_name"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "team_displayname"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
        ...
        Placeholders.register(Identifier.method_60655("player", "team_displayname_formatted"), (ctx, arg) -> {
            if (ctx.hasPlayer()) {
                var team = (Team) ctx.player().getScoreboardTeam();
