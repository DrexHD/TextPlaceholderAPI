...
public class ServerPlaceholders {
    public static void register() {
        Placeholders.register(Identifier.method_60655("server", "tps"), (ctx, arg) -> {
        ...
        Placeholders.register(Identifier.method_60655("server", "tps_colored"), (ctx, arg) -> {
            double tps = TimeUnit.SECONDS.toMillis(1) / Math.max(ctx.server().getAverageTickTime(), ctx.server().getTickManager().getMillisPerTick());
            String format = "%.1f";
        ...
        Placeholders.register(Identifier.method_60655("server", "mspt"), (ctx, arg) -> PlaceholderResult.value(String.format("%.0f", ctx.server().getAverageTickTime())));

        Placeholders.register(Identifier.method_60655("server", "mspt_colored"), (ctx, arg) -> {
        ...
        Placeholders.register(Identifier.method_60655("server", "time"), (ctx, arg) -> {
        ...
        Placeholders.register(Identifier.method_60655("server", "time_new"), (ctx, arg) -> {
...

        {
            ...
            Placeholders.register(Identifier.method_60655("server", "uptime"), (ctx, arg) -> {
        ...
        Placeholders.register(Identifier.method_60655("server", "version"), (ctx, arg) -> PlaceholderResult.value(ctx.server().getVersion()));

        Placeholders.register(Identifier.method_60655("server", "motd"), (ctx, arg) -> {
        ...
        Placeholders.register(Identifier.method_60655("server", "mod_version"), (ctx, arg) -> {
            if (arg != null) {
        ...
        Placeholders.register(Identifier.method_60655("server", "mod_name"), (ctx, arg) -> {
            if (arg != null) {
                var container = FabricLoader.getInstance().getModContainer(arg);
        ...
        Placeholders.register(Identifier.method_60655("server", "brand"), (ctx, arg) -> {
            return PlaceholderResult.value(Text.literal(ctx.server().getServerModName()));
        });

        Placeholders.register(Identifier.method_60655("server", "mod_count"), (ctx, arg) -> {
            return PlaceholderResult.value(Text.literal("" + FabricLoader.getInstance().getAllMods().size()));
        });

        Placeholders.register(Identifier.method_60655("server", "mod_description"), (ctx, arg) -> {
            if (arg != null) {
                var container = FabricLoader.getInstance().getModContainer(arg);
        ...
        Placeholders.register(Identifier.method_60655("server", "name"), (ctx, arg) -> PlaceholderResult.value(ctx.server().getName()));

        Placeholders.register(Identifier.method_60655("server", "used_ram"), (ctx, arg) -> {
        ...
        Placeholders.register(Identifier.method_60655("server", "max_ram"), (ctx, arg) -> {
            MemoryMXBean memoryMXBean = ManagementFactory.getMemoryMXBean();
            MemoryUsage heapUsage = memoryMXBean.getHeapMemoryUsage();
        ...
        Placeholders.register(Identifier.method_60655("server", "online"), (ctx, arg) -> PlaceholderResult.value(String.valueOf(ctx.server().getPlayerManager().getCurrentPlayerCount())));
        Placeholders.register(Identifier.method_60655("server", "max_players"), (ctx, arg) -> PlaceholderResult.value(String.valueOf(ctx.server().getPlayerManager().getMaxPlayerCount())));

        Placeholders.register(Identifier.method_60655("server", "objective_name_top"), (ctx, arg) -> {
            var args = arg.split(" ");
            if (args.length >= 2) {
        ...
        Placeholders.register(Identifier.method_60655("server", "objective_score_top"), (ctx, arg) -> {
            var args = arg.split(" ");
            if (args.length >= 2) {
                ServerScoreboard scoreboard = ctx.server().getScoreboard();
                ScoreboardObjective scoreboardObjective = scoreboard.getNullableObjective(args[0]);
