...
public class WorldPlaceholders {
    ...
    public static void register() {
        Placeholders.register(Identifier.method_60655("world", "time"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
        ...
        Placeholders.register(Identifier.method_60655("world", "time_alt"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
                world = ctx.player().getServerWorld();
            } else {
        ...
        Placeholders.register(Identifier.method_60655("world", "day"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
                world = ctx.player().getServerWorld();
            } else {
        ...
        Placeholders.register(Identifier.method_60655("world", "id"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
                world = ctx.player().getServerWorld();
            } else {
        ...
        Placeholders.register(Identifier.method_60655("world", "name"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
                world = ctx.player().getServerWorld();
            } else {
        ...
        Placeholders.register(Identifier.method_60655("world", "player_count"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
                world = ctx.player().getServerWorld();
            } else {
        ...
        Placeholders.register(Identifier.method_60655("world", "mob_count_colored"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
                world = ctx.player().getServerWorld();
            } else {
        ...
        Placeholders.register(Identifier.method_60655("world", "mob_count"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
                world = ctx.player().getServerWorld();
            } else {
        ...
        Placeholders.register(Identifier.method_60655("world", "mob_cap"), (ctx, arg) -> {
            ServerWorld world;
            if (ctx.player() != null) {
                world = ctx.player().getServerWorld();
            } else {
